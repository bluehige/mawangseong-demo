...
현재 제품 표시 버전은 `1.2`, 기술 SemVer와 최신 공개 안정판은 `1.2.5`입니다. 공개된 `v1.2.0`부터 `v1.2.5`까지의 태그는 이동하지 않습니다. 정식 Web/Windows 빌드는 같은 버전의 GitHub Release에 보관하고, 다음 확장 통합은 최신 `main`에서 새로 시작합니다.
