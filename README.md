...
현재 제품 표시 버전은 `1.2`, 프로젝트와 출시 후보의 기술 SemVer는 `1.2.6`입니다. 현재 공개 안정판은 Full·정식 빌드·태그 게이트가 끝날 때까지 `1.2.5`이며, 공개된 `v1.2.0`부터 `v1.2.5`까지의 태그는 이동하지 않습니다. 정식 Web/Windows 빌드는 같은 버전의 GitHub Release에 보관하고, 다음 확장 통합은 최신 `main`에서 새로 시작합니다.

- 바로 플레이: <https://bluehige.github.io/mawangseong-demo/web_Demo/>
- Windows/Web 정식 빌드: <https://github.com/bluehige/mawangseong-demo/releases/tag/v1.2.5>
