...
func _test_data_and_weakness() -> void:
	...
	_expect(not bool(definition.placeholder_art) and str(definition.get("sprite", "")) == "res://assets/sprites/uiux3d/bat_courier_sheet.png" and not definition.has("crown_form_id"), "Phase 30 포포 최종 16프레임·일반형 유지")
