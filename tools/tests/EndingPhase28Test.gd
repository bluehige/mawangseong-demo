...
func _test_e15_boundaries() -> void:
	...
	var failures := [
		...
		{"update3.distinct_link_skills_used_campaign": 2},
...
func _e15_boundary() -> Dictionary:
	return {"update3.final_battle_won": true, "update3.distinct_link_skills_used_campaign": 3, "update3.link_skill_used_day30": true, "update3.average_active_pair_bond": 65, "update3.max_monster_contribution_ratio": 0.40, "update3.day30_pair_member_down_count": 0}
