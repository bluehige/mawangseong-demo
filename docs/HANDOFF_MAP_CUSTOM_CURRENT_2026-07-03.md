...
- `S02_DIALOGUE` dialogue text was moved into a frame-safe text area, then the dialogue box was made taller and body text was vertically centered so short lines do not sit high in the frame.
