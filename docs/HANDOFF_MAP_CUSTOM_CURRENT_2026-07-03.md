...
Do not call the onboarding UI complete yet. Leon/Goldin/monster/intruder emotion variants, stage-specific art policy, and remaining reference-based polish are still open.
