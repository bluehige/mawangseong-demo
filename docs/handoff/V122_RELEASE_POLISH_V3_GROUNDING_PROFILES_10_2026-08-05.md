# v1.2.2 출시 마무리 핸드오프 — V3 goblin_ambush_captain 승급 앵커 10
...
- QA 문서: `docs/qa/V122_V3_GROUNDING_PROFILES_10_2026-08-05.md`

## 이번 패킷에서 한 일

`goblin_ambush_captain`의 192×192 idle/down 승급 자산을 직접 측정해 idle 발 앵커 `0.942708`, down 발 앵커 `0.854167`을 계산했다. 실제 alpha bbox `[20,17,180,181]`, `[8,1,192,164]`와 측정식을 전투 시각 프로필에 기록했다.
...
1. 다음 단일 패킷은 `V3-GROUNDING-PROFILES-11`로 `imp_flame_adept` 한 캐릭터의 idle/down 앵커를 같은 경로로 처리한다.
