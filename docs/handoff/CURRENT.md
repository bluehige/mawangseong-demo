...
- v2.0.1 STOVE 심의자료·Drive 업로드: `docs/handoff/V201_STOVE_RATING_MATERIALS_2026-07-15.md`
...
- v2.0.1 심의 설명서와 전체 문자열 5,411개·런타임 이미지 1,065개·캐릭터/몬스터/적 접촉표·엔딩 CG 23장을 제출 패키지로 만들었다.
- 초반 6:29, 중반 6:19, 후반 6:25와 E00~E22 전체 엔딩 4:08 영상을 1080p H.264/AAC로 생성해 대표 화면과 ID를 검증했다.
- 새 Windows 아이콘을 GPT 내부 이미지 생성으로 만들고 원본·출처·1024/256 PNG·7단계 ICO를 기록했다.
- Google Drive My Drive 루트에 67,585,284바이트 영상 ZIP과 78,854,208바이트 CG·대사·아이콘 ZIP을 업로드하고 Chrome에서 확인했다. 공유 권한은 변경하지 않았다.
...
- STOVE 포털 자체등급 페이지는 아직 `47924 (v.0.2.1)`을 선택하고 있다. 심사요청 전에 v2.0.1 빌드로 교체해야 하며, 사용자 지시대로 STOVE 업로드·심사요청은 수행하지 않았다.
...
5. STOVE v2.0.1 빌드·업로드·실행 설정을 완료하고 자체등급 페이지의 v0.2.1 선택값을 교체한 뒤 자체등급·빌드 심사를 진행한다.
