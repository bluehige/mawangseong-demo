...
- G1 수정 R2 Windows ZIP SHA-256: `7b86b0554f423f5f276396ca87e53d3a791ccf7d6311fe71cad008837d5fa793`
- G1 수정 R2 Web PCK SHA-256: `b3ac451afe990519b2a0c768b3b177dae95b0cbaa53ccc22429c61ce1a701cb9`
...
- U4 Reviewed SHA: `903ba65aa15da3d1aaaeb70fc9eb7a4f7cebc913`
- 제품 2.0 최종 UI U3 전투 HUD 핸드오프: `docs/handoff/V20_FINAL_UI_COMBAT_HUD_2026-07-27.md`
- U3 작업 브랜치: `codex/v20-final-ui-combat-hud`
- U3 기준: `release/v2.0@88cd1fef30da61d317e434ac9a0e844b42ef8fb2`
- U3 Reviewed SHA: `59e4fe5246414b05bdabcb24b8a4866c61c2019a`
- 제품 2.0 최종 UI U2 배치 화면 핸드오프: `docs/handoff/V20_FINAL_UI_PLACEMENT_2026-07-27.md`
- U2 작업 브랜치: `codex/v20-final-ui-placement`
- U2 기준: `release/v2.0@ee2caf96b34651b55e1afffd652f45bd3c03facf`
- U2 Reviewed SHA: `c5a29a335bd607652f7dde255bb88fbb3b633304`
...
- 제품 2.0 Phase 11T 단계 방어·몬스터 배치·전투 가독성: `docs/handoff/V20_PHASE11T_DEFENSE_STAGES_CLARITY_2026-07-22.md`
...
- U0 계약 PR #73, U1 공통 기반 PR #74, U2 배치 UI PR #75, U3 전투 HUD PR #76, U4 결과 화면 PR #77, U5 후보 PR #78은 `release/v2.0`에 병합됐다. 사용자의 연속 G1 수정 요청으로 U5와 R1 승인 대상은 무효이며 현재 단계는 수정 후보 R2 사용자 재확인 대기다.
...
- G1 수정 후보 R2에서 source SHA와 Windows·Web debug build hash를 다시 고정했고, 사용자가 동일 후보를 직접 플레이해 `V20_UI_OWNER_ACCEPTED`를 명시한 뒤에만 P0를 시작한다.
...
- U2 Reviewed SHA `c5a29a335bd607652f7dde255bb88fbb3b633304`에서 중앙 고정 지도, 시설·몬스터 카드, 유효·비유효 drag target, 설치·교체·이동·제거·Undo, 사용자 거부 toast와 하단 상태·되돌리기·방어 시작을 구현했다.
- U2 관련 검사는 배치 UX 42 assertions, 정보구조 100 assertions, 저장·재도전 56 assertions와 Windows OpenGL 초기·drag·거부·적용 4개 실제 렌더를 포함한 46 assertions가 PASS다. 전체 검수와 별도 검수 에이전트는 계획대로 실행하지 않았다.
...
- 수정 R1 후보는 추가 몬스터 카드 가독성 요청으로 승인 대상에서 제외됐다.
- 수정 R2 Reviewed SHA `2349299be955a02b0fddb00b045cf71207ad4e7b`에서 방 카드 왼쪽에 방·시설·수비대 정보를 유지하고 오른쪽에 큰 초상·이름·빈 슬롯을 세로 배치했다. 정원 2명은 크게, 정원 3명은 자동 축소해 표시한다.
- 수정 R2 관련 검사는 배치 GPU 62, 정보구조 115, 단일 공간모델 68, 결정 계약 24, 전체 UI 흐름 22 assertions가 PASS다. Windows ZIP SHA-256은 `7b86b0554f423f5f276396ca87e53d3a791ccf7d6311fe71cad008837d5fa793`, Web PCK SHA-256은 `b3ac451afe990519b2a0c768b3b177dae95b0cbaa53ccc22429c61ce1a701cb9`다.
- 수정 R2 후보는 `G1_OWNER_REPLAY_PENDING`이다. 사용자의 명시적 `V20_UI_OWNER_ACCEPTED` 전에는 P0와 `release/v2.0-product`를 시작하지 않는다.
...
- 테스트 빌드는 `test/web-v20-p11-intuitive-board` build commit `3fb2e1a29f089be6cc7fdaf77b7507d6b67aeaee`에 보존했고 repository-policy run `29798866580`이 PASS했다.
...
- 소스 PR #61이 `release/v2.0` merge commit `8b5022fa84a2a4697d02168972798f4ed26eac4f`로 통합됐고 repository-policy run `29893840673`이 PASS했다.
- 테스트 빌드는 `test/web-v20-p11s-castle-route-strategy` build commit `79d9174efebb323dfeeaa00456599a0afa57c8af`에 보존했다. 승인 문서 head는 `8e71cf7ac56725de52d90edb94d75387150485fb`, repository-policy run `29894445264`는 PASS다.
- 공개 저장소 content commit `7a217b1e8b2feaf0eb820cad3d08787b8ceae155`, PR #10 merge commit `f9710e1c2d8c4893acd473ff94be714ba2aef9f2`, Pages run `29894714534`로 배포했다.
