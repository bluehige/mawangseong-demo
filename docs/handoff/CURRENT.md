...
- 작업 단계: 전용 동료 큰 초상 5장, 후반 감정과 왕관 초상 연결 완료. 전체 미술 완료 아님.
- 작업 브랜치: codex/v126-uiux-u0-u3 (로컬, 미푸시)
- 기준 main/origin/main/원격 main: 69a75970b1f8c030aa3a6956e5ca0f5bf15b2112 (2026-09-13 재확인)
- Reviewed implementation SHA: 6682396a8011cdbc0ba43620e1d9ae5b4724dccf
- 최신 핸드오프: [UIUX_V2_COMPANION_PORTRAITS_2026-09-13.md](UIUX_V2_COMPANION_PORTRAITS_2026-09-13.md)
- 이전 시설·지도 확대: [UIUX_V2_STAGE_ART_NAVIGATION_2026-09-13.md](UIUX_V2_STAGE_ART_NAVIGATION_2026-09-13.md)
...
- 푸딩·고브·핀·모리의 큰 기본 초상 4장과 고브 eager 1장. GPT 내부 네이티브 RGBA, 원본/런타임 동일, 축소 저장 없음. 7.15 MiB.
- 작은 전투 프레임 확대를 전용 초상으로 교체하고 모리의 푸딩 재사용을 제거했다. 상세·회상·대화·타이틀·원정·결과 공통 연결.
- 실키·포포·의회 라이벌 3명의 기존 감정 18개 경로를 연결했다. 왕관 6종의 기본/승리/억제와 기존 진화 초상 선택을 검사했다.
- 기억이 없을 때 사라지던 안내 표시를 복원했다. 지도/드래그는 실제 전투 프레임을 계속 사용한다.
- Windows 1920×1080 / 1280×720 × 글자 90/100/115%. 직접 검사 1,414개와 스토리 관련 58개 PASS.
- 전후 126쌍과 왕관 추가 12장: tmp/uiux_portraits_20260913/index.html. 결과/대화 표시에는 통제 fixture를 사용했으며 실제 전투 완주 증거가 아니다.
- 이미 완료한 건설·Undo, 단계 시설 11종, 성문/왕좌/빈 기반 15종, 수호핵 6장, 병영 4방향, 기본 시설 12장, 대표 전투 캐릭터 8종은 유지했다.
- 다음 우선: 타 인물 큰 초상을 재사용하는 돌콩·두둠·루미·미미, 나머지 후반 전투/큰 초상, 보조 메뉴 구조.
