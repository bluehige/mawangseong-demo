...
- 저장소 근거, 보존·폐기 후보, 필수 설계 질문, 실제 물리 전투 테스트와 최초 구현 PR 산출물을 강제하는 GPT Pro 요청서를 `docs/briefs/GPT_PRO_V20_RECOVERY_REQUEST_2026-07-22.md`에 고정했다. GPT Pro 답변을 받은 뒤 사용자 승인 가능한 새 마스터 명세와 단계별 복구 계획으로 변환한다.
