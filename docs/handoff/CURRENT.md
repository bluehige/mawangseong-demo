...
- 제품 2.0 Phase 11 블라인드 판매성 게이트 준비: `docs/handoff/V20_PHASE11_SELLABILITY_GATE_PREP_2026-07-21.md`
...
- 제품 2.0은 `origin/main`의 `7ee0b50965dd3944a7ab737c0eca76d2df2a82ad`에서 시작해 `release/v2.0`에 순차 통합하는 DAY 1~5 PC 버티컬 슬라이스 재설계다. Phase 0~10은 PR #44~#54로 통합됐고 Phase 11은 `test/v20-p11-sellability`에서 실제 참가자를 기다리는 `PENDING` 상태다.
...
- Phase 11은 중립 진행 프로토콜, 익명 원본 구조와 80%·70%·70% 판정기를 준비했다. 현재 실제 참가자 0명으로 `PENDING`이며 합성 결과로 통과시키지 않는다. Phase 12는 시작 금지 상태다.
