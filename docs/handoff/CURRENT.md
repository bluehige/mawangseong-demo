...
- 작업명: 캐릭터와 미궁 벽의 앞뒤 가림·관련 검증 완료
- WORKSTREAM_ID: UIUX-V2-ACTOR-WALL-DEPTH-20260913
- 브랜치: codex/v126-uiux-u0-u3 (로컬 미푸시)
- main/origin/main/실제 원격 main: 69a75970b1f8c030aa3a6956e5ca0f5bf15b2112 (2026-09-13 착수 확인)
- Reviewed implementation SHA: 96466221d09f7427dd523b6f6dc5cb9d058b9442
- 최신 핸드오프: [UIUX_V2_ACTOR_WALL_DEPTH_2026-09-13.md](UIUX_V2_ACTOR_WALL_DEPTH_2026-09-13.md)
- 사용자가 돌바닥을 승인하고 캐릭터와 벽의 앞뒤 가림을 요청했다. 기존 벽/바닥 그래픽은 유지했다.
- 관리 화면의 배치 몸체와 전투 아군/적에 동일한 벽 표면 깊이 버퍼를 적용했다. 앞벽 뒤 몸체 픽셀을 제외하고 뒤벽 앞 몸체를 유지하며 실제 발 위치로 갱신한다.
- 그림자·바닥 선택 링도 가림을 따르고 이름·체력·상태 안내 및 조작 중인 드래그는 보이게 유지한다. 전투 효과 합성 층도 연결했다.
- Windows 1920×1080/1280×720 × 글자90/100/115%: 벽 가림850 assertions·30장, 미궁30,178 assertions·100장, 건설344 checks·36장, 전투210 assertions·24장, VFX깊이30 assertions 및 기존 깊이 계약 PASS.
- 앞뒤 픽셀 비교와 실제 Unit 물리 이동을 구분해 검증했다. 초기 테스트 좌표/팝업 입력 실패와 최종 수정·재검증 근거는 핸드오프에 남겼다.
- 저장소 정책 PASS: 694개 최종 경로 / 57커밋, 437ea5a6c5c0425ab9a6a086625dffc2425a4d06 기준. 이후 핸드오프 결과 기록만 추가.
- 비교: tmp/uiux_actor_depth_20260913/index.html. 검증 목록: 같은 폴더 verification.json.
- 승인된 돌바닥 출처/구현: [UIUX_V2_TORCHLIT_FLAGSTONE_2026-09-13.md](UIUX_V2_TORCHLIT_FLAGSTONE_2026-09-13.md). 바닥 SHA256 8f50dfb9f466bd0aeb054e249efbde915b28da966f350f99069b9302eb847d7c 유지.
- 시설/문 아치 스프라이트 자체는 정밀 깊이 마스크의 대상이 아니며, 액터 합성 층 변경에 따른 소품과의 앞뒤는 후속 확인 영역이다.
...
1. tmp/uiux_actor_depth_20260913/index.html에서 캐릭터의 벽 앞뒤와 실제 이동, 배치 화면 전후를 확인한다. 기존 저장은 기존 지도를 유지하므로 새 미궁 확인에는 새 게임을 사용한다.
2. 후속 가림 피드백은 실제 위치와 벽/시설/문 아치를 구분해 보완한다. 현재 검증을 전체 DAY 1~30·사람 검수 결과로 확대하지 않는다.
