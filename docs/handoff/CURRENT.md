...
| `test/web-v0.3` | `b4cbc52b60e906577337c90e7faf2c336a89fedb` | 181,259,112바이트 적 우클릭 수정 PCK와 LFS 기준 |
| `v.02` | `98eb6e666fe1d933f9121bc83fb41ba75ed2ca69` | v0.2 완성 계보 |
| `v.03` | `199d2d0347e78f9c62b1c15e9369231384235900` | 기존 v0.3 완성 계보 |

## 완료 상태

- DAY 01 적 우클릭 판정을 강조 영역과 일치시키고 새 Web PCK 181,259,112바이트를 `test/web-v0.3`, Release와 Pages에 게시했다.
