...
- 작업 단계: 실제 성문·왕좌·빈 건설 구역 15장과 전체 지도 맞춤 연결, 후반 NW 슬롯 클릭/드롭 결함 수정. 전체 미술 완료 아님.
- 작업 브랜치: codex/v126-uiux-u0-u3 (로컬, 미푸시)
- 기준 main/origin/main/원격 main: 69a75970b1f8c030aa3a6956e5ca0f5bf15b2112 (2026-09-13 원격 확인)
- Reviewed implementation SHA: 5f20e889559c5e17392ab962d526590aa8e5abcc
- 최신 핸드오프: [UIUX_V2_LANDMARKS_2026-09-13.md](UIUX_V2_LANDMARKS_2026-09-13.md)
...
- 새 15장 모두 GPT 내부 네이티브 RGBA, 원본/런타임 바이트 동일, 축소 저장 없음. 성문 SE/왕좌 SW/빈 기반 NE 4단계 및 보조 입구 NE·빈 기반 NW/SE 연결.
- 단계 2 왕좌의 중복 앞 계단 제거. 기존 실제 건설 구역·렌더 투영·앞벽·저장/게임 규칙 보존.
- 후반 NW 슬롯이 도구함에 가려지는 기존 입력 결함 재현 후 전체 지도 맞춤과 “지도 전체” 버튼으로 복구.
- 직접 검사 2,014개(관리 24조건, 빈 슬롯 배치 36사례, 철거/Undo 24사례), 건설 안전 343개, 기존 시각 계약 4종 PASS.
- 최종 전투 진입/왕좌 겹침 8사례 274개 PASS. 겹침은 표시 위치를 옮긴 fixture이며 실제 AI 완주 증거가 아님.
- Windows 1920×1080 / 1280×720 × 글자 90/100/115%. 전후 캡처 232/256장: tmp/uiux_landmarks_20260913/index.html.
- 신규 런타임 PNG 20.83 MiB. 단계 순회 종료 텍스처 메모리 약 614.59 MiB 관측, 저사양 성능 판정 아님.
- 남은 단계별 시설·후반 캐릭터·큰 초상·보조 메뉴 구조·지도 세부 가독성과 전체 미술 조화는 후속 작업.
