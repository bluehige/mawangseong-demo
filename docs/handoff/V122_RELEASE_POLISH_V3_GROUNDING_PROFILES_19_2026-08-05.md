# V122 출시 마무리 핸드오프 — V3-GROUNDING-PROFILES-19
...
- QA: `docs/qa/V122_V3_GROUNDING_PROFILES_19_2026-08-05.md`

## 2. 목표와 실제 변경

`stone_sentinel` 한 캐릭터의 4×4 전투 시트에서 idle `(0,0)`과 down `(2,0)`의 알파 bbox를 확인하고 발 앵커를 `combat_visual_profiles.json`에 연결했다. 런타임 소비자는 기존 공통 `DataRegistry`·`Unit` 경로를 그대로 사용하며, 이번 패킷에서는 공통 코드를 수정하지 않았다.
...
- idle bbox `[9, 18, 183, 183]`, anchor `[0.5, 0.953125]`
- down bbox `[9, 26, 183, 183]`, anchor `[0.5, 0.953125]`
