...
func _step_label(step_id: String) -> String:
	var labels := {
		...
		"TUT_060_ROOM_BLOCK": "입구 봉쇄",
		"TUT_070_DIRECT_CONTROL": "직접 조종",
		"TUT_075_DIRECT_ATTACK": "직접 공격",
		"TUT_080_BATTLE_LOG": "전투 기록 확인",
		"TUT_090_RESULT_GROWTH": "성장 확인",
		"TUT_110_TREASURE": "보물방 선택",
		"TUT_120_TRAP_LURE": "함정 유도",
		"TUT_130_GOBLIN_CONTROL": "고블린 추격",
		"TUT_210_RECOVERY_NEST": "회복 둥지 선택",
		"TUT_220_RETREAT_LINE": "후퇴선",
		"TUT_230_IMP_FIREBALL": "임프 화염구",
