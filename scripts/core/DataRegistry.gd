...
var v20_runtime_layout: Dictionary = {}
...
const V20_RUNTIME_LAYOUT_ID = V20SpatialModelScript.RUNTIME_LAYOUT_ID
...
func load_all() -> void:
	...
	v20_onboarding = _load_json("res://data/v20/onboarding.json")
	...
	v20_runtime_layout = V20SpatialModelScript.to_module_graph_layout(V20SpatialModelScript.board_from_catalog(v20_dungeon_layouts))
...
func quarter_layout(layout_id: String = "") -> Dictionary:
	...
	if selected_id == V20_RUNTIME_LAYOUT_ID and not v20_runtime_layout.is_empty():
		return v20_runtime_layout.duplicate(true)
